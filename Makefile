...
LIBBUTANO   	:=  ../../butano
PYTHON      	:=  python
SOURCES     	:=  src ../../common/src#src
INCLUDES    	:=  include ../../common/include#include
DATA        	:=
GRAPHICS    	:=  graphics ../../common/graphics#graphics graphics/shape_group_textures
#AUDIO       	:=  audio
#DMGAUDIO    	:=  dmg_audio
ROMTITLE    	:=  TEST_PROJECT
ROMCODE     	:=  STPJ
USERFLAGS   	:=  
USERCXXFLAGS	:=  
USERASFLAGS 	:=  
